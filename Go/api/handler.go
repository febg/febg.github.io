...
func (c *Controller) SendEmail(w http.ResponseWriter, r *http.Request) {
	...
	if password == "Bespoke4Life" {
		m.SetBody("text/html", `<body style ="text-align:center">
Thank you for RSVPing for our VIP Event celebrating bespoke suiting. <br /><br />

            You have been added to the guest list and will receive a reminder email the night before the event.
            Looking forward to hosting you!.<br /><br/>
